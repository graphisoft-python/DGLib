...
public:
	...
	*/
	...
	GenericValue(bool b) : data_ (), flags_(b ? kTrueFlag : kFalseFlag) {
	}
	...
	*/
	GenericValue& AddMember(GenericValue& name, GenericValue& value, Allocator& allocator) {
		...
		new (&o.members[o.size].name) GenericValue();
		new (&o.members[o.size].value) GenericValue();
	...
	template <typename T>
	GenericValue& AddMember(const char* name, Allocator& nameAllocator, T value, Allocator& allocator) {
		GenericValue n(name, internal::StrLen(name), nameAllocator);
		GenericValue v(value);
		return AddMember(n, v, allocator);
	}
	...
	*/
	...
	bool RemoveMember (SizeType index) {
		RAPIDJSON_ASSERT(IsObject());
		RAPIDJSON_ASSERT(data_.o.members != 0);
		if (index >= data_.o.size) {
			return false;
		}

		RemoveMember (data_.o.members + index);
		return true;
	}
...
\endcode
	...
	*/
	GenericValue& PushBack(GenericValue& value, Allocator& allocator) {
		...
		new (&data_.a.elements[data_.a.size]) GenericValue();
...
typedef GenericValue<UTF8 <>, CrtAllocator> GenericValueType;
typedef GenericDocument<UTF8 <>, CrtAllocator> DocumentType;

} // namespace rapidjson

#define VALUECAST static_cast< ::rapidjson::GenericValueType* >
#define DOCUMENTCAST static_cast< ::rapidjson::DocumentType* >
