...
struct GDL_CPP_DLL_EXPORT ParamListUserData
{
	short			dataType;
	unsigned char	flags;
	char			filler;
...
class GDL_CPP_DLL_EXPORT ParamList : public PropertyList<ParamListUserData>
{
public:
	...
	void ParamsToParamList (const double params[26]);
