// *********************************************************************************************************************
// Description:		XML writer class based on the SAX api. (No namespace support)
//
// Module:			GSXML
// Namespace:		GSXML
// Contact person:	FM
...
#if !defined(SAXWRITER_HPP)
#define SAXWRITER_HPP
...
class GSXMLUTILS_EXPORT SAXWriter : public xercesc::DocumentHandler
{
public :
public:
    ...
    //@{
    /** Default constructor */
    SAXWriter	( xercesc::XMLFormatter&	output );
