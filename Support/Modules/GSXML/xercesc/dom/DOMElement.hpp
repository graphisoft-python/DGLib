...
/*
 * $Id: DOMElement.hpp 527149 2007-04-10 14:56:39Z amassari $
 */
...
public:
     ...
     *
     */
	// Tobb RTTI jon letre, ha a header-ben van implementalva a virtualis destructor. 
	//  Ezert a DOMRTTIs.cpp-be mozgattuk a destructor implementaciojat
    virtual ~DOMElement();
    //@}
