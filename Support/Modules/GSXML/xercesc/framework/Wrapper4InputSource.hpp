...
public:
  ...
  /**
    ...
    *
    */
    virtual const XMLCh* getStringData() const override;
  ...
  /**
    ...
    * @see InputSource
    */
    virtual InputSource* getByteStream() const override;
    //@}
  ...
  /**
    ...
    * @see #setEncoding
    */
    virtual const XMLCh* getEncoding() const override;
  ...
  /**
    ...
    * @see #setPublicId
    */
    const XMLCh* getPublicId() const override;
  ...
  /**
    ...
    * @see #setSystemId
    */
    const XMLCh* getSystemId() const override;
    ...
    */
    bool getIssueFatalErrorIfNotFound() const override;
  ...
  /**
    ...
    *
    */
    virtual void setStringData(const XMLCh* data) override;

  /**
    * This wrapper only exposes the given InputSource, no setting allowed
    *
    */
    virtual void setByteStream(InputSource* stream) override;
  ...
  /**
    ...
    */
    void setEncoding(const XMLCh* const encodingStr) override;
  ...
  /**
    ...
    * @see #getPublicId
    */
    void setPublicId(const XMLCh* const publicId) override;
  ...
  /**
    ...
    */
    void setSystemId(const XMLCh* const systemId) override;
    ...
    * @since DOM Level 3
    */
    void setBaseURI(const XMLCh* const baseURI) override;
  ...
  /**
    ...
    */
    void setIssueFatalErrorIfNotFound(bool flag) override;
